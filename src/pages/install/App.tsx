...
const usePermissions = (scriptInfo: ScriptInfo | undefined, metadata: TMetadata) => {
  const { t } = useTranslation();
...
const useScriptDescription = (scriptInfo: ScriptInfo | undefined, metadata: TMetadata) => {
  const { t } = useTranslation();
...
function App() {
  ...
  const metadata = scriptInfo?.metadata || ({} as TMetadata);
